...
const HERBS = {
    mint:            { name: "Mint",             hours: 2,  points: 10,  level: 1  },
    clover:          { name: "Clover",           hours: 2,  points: 8,   level: 1  },
    rosemary:        { name: "Rosemary",         hours: 3,  points: 12,  level: 1  },
    daisy:           { name: "Daisy",            hours: 2,  points: 9,   level: 1  },
    basil:           { name: "Basil",            hours: 3,  points: 11,  level: 1  },
    lavender:        { name: "Lavender",         hours: 6,  points: 18,  level: 2  },
    chamomile:       { name: "Chamomile",        hours: 5,  points: 15,  level: 2  },
    sunpetal:        { name: "Sunpetal",         hours: 4,  points: 14,  level: 2  },
    violet:          { name: "Violet",           hours: 4,  points: 13,  level: 2  },
    rose:            { name: "Rose",             hours: 6,  points: 20,  level: 3  },
    tulip:           { name: "Tulip",            hours: 5,  points: 16,  level: 3  },
    moonflower:      { name: "Moonflower",       hours: 10, points: 28,  level: 4  },
    firebloom:       { name: "Firebloom",        hours: 7,  points: 22,  level: 4  },
    nightshade:      { name: "Nightshade",       hours: 9,  points: 26,  level: 4  },
    stardust:        { name: "Stardust Fern",    hours: 8,  points: 25,  level: 5  },
    crystal_lily:    { name: "Crystal Lily",     hours: 10, points: 30,  level: 5  },
    stargrass:       { name: "Stargrass",        hours: 8,  points: 24,  level: 5  },
    moonshroom:      { name: "Moonshroom",       hours: 14, points: 35,  level: 6  },
    aurora_moss:     { name: "Aurora Moss",      hours: 12, points: 38,  level: 7  },
    dreambloom:      { name: "Dreambloom",       hours: 13, points: 40,  level: 7  },
    starbeam_orchid: { name: "Starbeam Orchid",  hours: 16, points: 50,  level: 8  },
    shadowfern:      { name: "Shadowfern",       hours: 14, points: 45,  level: 8  },
    galactic_vine:   { name: "Galactic Vine",    hours: 18, points: 58,  level: 9  },
    nebula_flower:   { name: "Nebula Flower",    hours: 20, points: 65,  level: 9  },
    celestial_bloom: { name: "Celestial Bloom",  hours: 22, points: 75,  level: 10 },
    void_lotus:      { name: "Void Lotus",       hours: 24, points: 80,  level: 10 },
    prism_petal:     { name: "Prism Petal",      hours: 30, points: 100, level: 12 },
    cosmic_fern:     { name: "Cosmic Fern",      hours: 28, points: 95,  level: 12 },
    fairy_queen_rose:{ name: "Fairy Queen Rose", hours: 48, points: 150, level: 15 },
    infinity_bloom:  { name: "Infinity Bloom",   hours: 72, points: 200, level: 15 },
};
